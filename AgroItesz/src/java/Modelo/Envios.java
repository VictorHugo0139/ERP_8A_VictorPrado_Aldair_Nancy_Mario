...
public class Envios {
    ...
    public Envios(int idEnvio, Date fechaEntregaPlaneada, Date fechaEntregaReal, String dirección, int codigoPostal, int idVenta, int idTransporte, int idCiudad, char Estado) {
