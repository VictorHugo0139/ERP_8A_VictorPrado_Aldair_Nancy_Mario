...
<body style="background-color: #dfd7f5;">
    ...
    <div style="margin-left: 180px; margin-top: 10px" id="divI">
        <form action="Controlador?accion=VentasDetalles" method="POST" name="formInsertar" onsubmit="return Validar(formInsertar);">
            <table border="0" style="width: 100%">
                <tbody>
                    <tr>
                        <td style="width: 25%" colspan="2"><input type="text" placeholder="precio de venta" name="txtPrecio" style="width: 90%;" required/></td>
                        <td style="width: 25%" colspan="2"><input type="text" placeholder="Cantidad" name="txcantidad" style="width: 90%;" required /></td>
                        <td style="width: 25%"><input type="text" placeholder="subtotal" name="txtRazonSocial" style="width: 90%;" required/></td>
                    </tr>

                    <tr>
                        <td colspan="2"><input type="Venta" placeholder="Email" name="txtEmail" style="width: 90%;" required/></td>
                        <td colspan="2"><input type="Presentacion" placeholder="Email" name="txtEmail" style="width: 90%;" required/></td>
                        <td colspan="2"><input type="Estatus" placeholder="Estatus" name="txtEstatus" required/></td>
                    </tr>
