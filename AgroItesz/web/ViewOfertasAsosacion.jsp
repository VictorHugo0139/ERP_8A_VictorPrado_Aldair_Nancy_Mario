...
<%@page import="Modelo.datos.OfertasAsosacionesDAO"%>
...
<%
    OfertasAsosacionesDAO dao= new OfertasAsosacionesDAO();
    ...
    <div style="margin-left: 180px; margin-top: 5px; border: 1px solid #aa0bb0; height: 400px; width: 1100px;">
        <table width='100%' border='0' cellpadding='0' id='customers' >
            <thead>
                ...
                <tr>
                    <th id='tde' width='10%' style='border: 0;' scope='col'>idAsosaciones</th>
            ...
            <%
                // datos =  dao.consultar();
                for (OfertasAsosaciones Al : datos) {

            %>
            <tbody>
                <tr>
                    <th><%=  Al.getIdAsosaciones()%></th>
                    <th><%=  Al.getIdOferta()%></th>
                    <th><%= Al.getEstatus()%></th>
